        ...
        <div className='block max-w-sm rounded-lg bg-white shadow-lg'>
          ...
          <div className='p-6'>
            ...
            <button
              ...
              className='text-pastelBlack placeholder:font-space !bg-amber-500 hover:!bg-amber-600 transition duration-75 ease-in font-medium rounded-lg text-base px-6 py-3.5 text-center'>
              {props.button}
            </button>
            <p>
